...
public class StudentPredicate {
	...
	public static void main(String[] args) {
		List<Student> students = Arrays.asList(new Student("Nikhil", 80), new Student("Ram", 50),
				new Student("Dheeraj", 90), new Student("Mayuresh", 60), new Student("Purva", 30),
				new Student("Preksha", 40));
